...
class CreateForm(forms.Form):
    ...
    def __init__(self, request, *args, **kwargs):
        ...
        self.fields['group_id'].initial = self.getgroup_id()
    ...
    def clean(self):
        if self.request.POST['h5p_type'] == 'upload':
            ...
            if not libraryData:
                ...
                content['group_id'] = self.request.POST['group_id']
    ...
    def getgroup_id(self):
        if 'group_id' in self.request.GET:
            return self.request.GET['group_id']
        else:
            return ''
